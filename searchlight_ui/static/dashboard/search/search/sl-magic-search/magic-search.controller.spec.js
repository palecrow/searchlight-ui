...
(function () {
  ...
  describe('MagicSearchController', function () {
    ...
    beforeEach(module('searchlight-ui.dashboard.search.search.sl-magic-search'));
    beforeEach(inject(function($controller, _$timeout_, $window, $rootScope, $injector) {
      $timeout = _$timeout_;
      scope = $rootScope.$new();
      scope.strings = { prompt: "Hello World!" };
      scope.facets_param = [];
      service = $injector.get('searchlight-ui.dashboard.search.search.sl-magic-search.service');
  ...
  describe('MagicSearch module', function () {
    it('should be defined', function () {
      expect(angular.module('searchlight-ui.dashboard.search.search.sl-magic-search')).toBeDefined();
    });
  });
