...
(function() {
  ...
  angular.module('searchlight-ui.dashboard.search.search.sl-magic-search')
    .factory('searchlight-ui.dashboard.search.search.sl-magic-search.service', magicSearchService);

  magicSearchService.$inject = [];

  /**
   * @ngdoc service
   * @name searchlight-ui.dashboard.search.search.sl-magic-search.service
   *
   * @returns the service.
   */
